...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for SpotifyWebApiClient initialization.
...
$logger = new Logger('SpotifyWebApi');
