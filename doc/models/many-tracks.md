...
|  --- | --- | --- | --- | --- | --- |
| `tracks` | [`TrackObject[]`](../../doc/models/track-object.md) | Required | - | getTracks(): array | setTracks(array tracks): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use SpotifyWebApiLib\Models\Builders\ManyTracksBuilder;
