...
| `tracks` | [`?PlaylistTracksRefObject`](../../doc/models/playlist-tracks-ref-object.md) | Optional | - | getTracks(): ?PlaylistTracksRefObject | setTracks(?PlaylistTracksRefObject tracks): void |
