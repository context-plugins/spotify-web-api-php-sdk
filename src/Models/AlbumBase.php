...
class AlbumBase implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the AlbumBase object to a human-readable string representation.
     *
     * @return string The string representation of the AlbumBase object.
     */
