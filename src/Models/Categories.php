...
class Categories implements \JsonSerializable
{
    ...
    /**
     * Converts the Categories object to a human-readable string representation.
     *
     * @return string The string representation of the Categories object.
     */
