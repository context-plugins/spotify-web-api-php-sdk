...
class ChapterObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * Returns Audiobook.
     */
    public function getAudiobook(): AudiobookBase
    {
     ...
     * @maps audiobook
     */
    public function setAudiobook(AudiobookBase $audiobook): void
    {
        $this->audiobook = $audiobook;
    }

    /**
     * Converts the ChapterObject object to a human-readable string representation.
     *
     * @return string The string representation of the ChapterObject object.
     */
