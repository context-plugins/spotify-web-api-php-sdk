...
class CurrentlyPlayingContextObject implements \JsonSerializable
{
    ...
    /**
     * Converts the CurrentlyPlayingContextObject object to a human-readable string representation.
     *
     * @return string The string representation of the CurrentlyPlayingContextObject object.
     */
