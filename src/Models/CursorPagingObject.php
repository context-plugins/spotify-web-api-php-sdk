...
class CursorPagingObject implements \JsonSerializable
{
    ...
    /**
     * Converts the CursorPagingObject object to a human-readable string representation.
     *
     * @return string The string representation of the CursorPagingObject object.
     */
    ...
    protected $propertyNames = ['href', 'limit', 'next', 'cursors', 'total'];
