...
class DisallowsObject implements \JsonSerializable
{
    ...
    /**
     * Converts the DisallowsObject object to a human-readable string representation.
     *
     * @return string The string representation of the DisallowsObject object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'DisallowsObject',
            [
                'interruptingPlayback' => $this->interruptingPlayback,
                'pausing' => $this->pausing,
                'resuming' => $this->resuming,
                'seeking' => $this->seeking,
                'skippingNext' => $this->skippingNext,
                'skippingPrev' => $this->skippingPrev,
                'togglingRepeatContext' => $this->togglingRepeatContext,
                'togglingShuffle' => $this->togglingShuffle,
                'togglingRepeatTrack' => $this->togglingRepeatTrack,
