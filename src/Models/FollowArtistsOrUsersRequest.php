...
class FollowArtistsOrUsersRequest implements \JsonSerializable
{
    /**
     * @var string[]
     */
    ...
    /**
     * Converts the FollowArtistsOrUsersRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FollowArtistsOrUsersRequest object.
     */
