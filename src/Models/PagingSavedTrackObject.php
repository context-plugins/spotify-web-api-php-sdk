...
class PagingSavedTrackObject implements \JsonSerializable
{
    ...
    /**
     * Converts the PagingSavedTrackObject object to a human-readable string representation.
     *
     * @return string The string representation of the PagingSavedTrackObject object.
     */
