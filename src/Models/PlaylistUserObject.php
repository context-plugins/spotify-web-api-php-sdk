...
class PlaylistUserObject implements \JsonSerializable
{
    ...
    /**
     * Converts the PlaylistUserObject object to a human-readable string representation.
     *
     * @return string The string representation of the PlaylistUserObject object.
     */
    ...
    protected $propertyNames = ['external_urls', 'followers', 'href', 'id', 'type', 'uri'];
