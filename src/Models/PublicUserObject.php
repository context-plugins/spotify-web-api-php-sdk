...
class PublicUserObject implements \JsonSerializable
{
    ...
    /**
     * Converts the PublicUserObject object to a human-readable string representation.
     *
     * @return string The string representation of the PublicUserObject object.
     */
    ...
    protected $propertyNames = ['display_name', 'external_urls', 'followers', 'href', 'id', 'images', 'type', 'uri'];
