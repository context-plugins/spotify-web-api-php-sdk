...
class SavedAlbumObject implements \JsonSerializable
{
    ...
    /**
     * Converts the SavedAlbumObject object to a human-readable string representation.
     *
     * @return string The string representation of the SavedAlbumObject object.
     */
    ...
    protected $propertyNames = ['added_at', 'album'];
