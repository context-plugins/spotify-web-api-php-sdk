...
class SavedTrackObject implements \JsonSerializable
{
    ...
    /**
     * Converts the SavedTrackObject object to a human-readable string representation.
     *
     * @return string The string representation of the SavedTrackObject object.
     */
    ...
    protected $propertyNames = ['added_at', 'track'];
