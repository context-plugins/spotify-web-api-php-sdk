...
class SegmentObject implements \JsonSerializable
{
    ...
    /**
     * Converts the SegmentObject object to a human-readable string representation.
     *
     * @return string The string representation of the SegmentObject object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'loudnessStart' => $this->loudnessStart,
                'loudnessMax' => $this->loudnessMax,
                'loudnessMaxTime' => $this->loudnessMaxTime,
                'loudnessEnd' => $this->loudnessEnd,
