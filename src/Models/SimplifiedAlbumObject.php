...
class SimplifiedAlbumObject implements \JsonSerializable
{
    ...
    /**
     * Converts the SimplifiedAlbumObject object to a human-readable string representation.
     *
     * @return string The string representation of the SimplifiedAlbumObject object.
     */
