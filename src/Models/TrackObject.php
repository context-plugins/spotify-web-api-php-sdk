...
class TrackObject implements \JsonSerializable
{
    /**
     * @var SimplifiedAlbumObject|null
     */
    private $album;
     ...
     * Returns Album.
     */
    public function getAlbum(): ?SimplifiedAlbumObject
    {
        return $this->album;
    }
     ...
     * @maps album
     */
    public function setAlbum(?SimplifiedAlbumObject $album): void
    {
        $this->album = $album;
    }
     ...
     * @maps artists
     *
     * @param ArtistObject[]|null $artists
     */
    ...
    /**
     * Returns Is Playable.
     * Part of the response when [Track Relinking](https://developer.spotify.com/documentation/web-
     * api/concepts/track-relinking) is applied. If `true`, the track is playable in the given market.
     * Otherwise `false`.
     */
     ...
     *
     * @maps type
     * @factory \SpotifyWebApiLib\Models\Type3::checkValue
     */
    ...
    /**
     * Converts the TrackObject object to a human-readable string representation.
     *
     * @return string The string representation of the TrackObject object.
     */
